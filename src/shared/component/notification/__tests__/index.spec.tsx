...
describe('Notification component', () => {
  ...
  it('should render an alert with success severity', () => {
    render(<Notification message="Sucesso" type="success" open={true} />);
  ...
  it('should render an alert with error severity', () => {
    render(<Notification message="Erro inesperado" type="error" open={true} />);
  ...
  it('should render an alert with warning severity', () => {
    render(<Notification message="Atenção" type="warning" open={true} />);
  ...
  it('should not render the notification when open is false', () => {
    render(
      <Notification message="Mensagem escondida" type="success" open={false} />,
    );
